...
export default function Preview() {
  ...
  useEffect(() => {
    ...
    const getQr = () => {
      fetch('https://api.qrserver.com/v1/create-qr-code/?data=' + input + '&size=200x200&qzone=5&format=' + currentImgType + '&color=' + currentColor)
      .then(response => response.blob())
      .then(blob => {
        const url = URL.createObjectURL(blob); 
        setSrc(url)
    ...
    <div className='rounded-md my-shadow  preview p-5 w-[45%]'>
      ...
      <div>
        ...
        <div className="flex justify-center ">
          <div className='w-[300px] h-[300px] relative my-fa-img'>
            {
              loading && <div className='absolute left-[50%] top-[50%] transform translate-x-[-50%] translate-y-[-50%]'>
            ...
            <img className={`w-full h-full ${loading && 'opacity-25'}`}  src={src} />
